...
INSERT INTO QUESTION (id, writer_id, title, contents, created_date_time, updated_date_time, has_deleted)
VALUES (null, 1, '음...', '테스트', NOW(), NOW(), false);
INSERT INTO QUESTION (id, writer_id, title, contents, created_date_time, updated_date_time, has_deleted)
VALUES (null, 2, '지워진 글', '지워졌으니 못봐요.', NOW(), NOW(), true);
INSERT INTO ANSWER(id, comment, created_date_time, updated_date_time, question_id, writer_id, has_deleted)
